...
<div class="container">
    ...
    <ul class="tabs">
        <li class="{{ $tab === 'pending' ? 'active' : '' }}">
            <a href="{{ route('attendance.request', ['tab' => 'pending']) }}">承認待ち</a>
        </li>
        <li class="{{ $tab === 'approved' ? 'active' : '' }}">
            <a href="{{ route('attendance.request', ['tab' => 'approved']) }}">承認済み</a>
        </li>
    </ul>
    ...
    <table class="request-table">
        ...
        @forelse ($requests as $req)
            <tr>
                ...
                <td><a href="{{ route('attendance.detail', $req->attendance->id) }}" class="detail-btn">詳細</a></td>
            </tr>
